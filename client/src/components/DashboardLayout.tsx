...
import {
  LayoutDashboard, BarChart3, Video, Settings, RefreshCw,
  PanelLeft, TrendingUp, User,
} from "lucide-react";
...
const menuItems = [
  ...
  { icon: Video, label: "VSL Detail", path: "/vsl" },
          ...
          <SidebarFooter className="p-3">
            <div className="flex items-center gap-3 rounded-lg px-1 py-1 w-full text-left group-data-[collapsible=icon]:justify-center">
              ...
              <div className="flex-1 min-w-0 group-data-[collapsible=icon]:hidden">
                ...
                <p className="text-xs text-muted-foreground truncate mt-1.5">Acesso livre</p>
              </div>
            </div>
          </SidebarFooter>
        </Sidebar>
